...
- If selected, mirrors `src/media/` into `public/media/` to make assets available on the website.
...
- **Media Handling (Option A - Recommended)**: Copies relevant `src/media/` assets to `public/media/` during the update process to ensure they are available for the Next.js/Fumadocs application.
